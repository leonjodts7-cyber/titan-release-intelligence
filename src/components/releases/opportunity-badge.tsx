...
const ACTION_STYLES: Record<OpportunityAction, string> = {
  "TOP OPPORTUNITY": "bg-fuchsia-500/15 text-fuchsia-300 border-fuchsia-500/40",
  "MUST WATCH": "bg-red-500/15 text-red-400 border-red-500/30",
  "HIGH PRIORITY": "bg-orange-500/15 text-orange-400 border-orange-500/30",
...
export function OpportunityBadge({
  ...
  return (
    <span className={cn(
      "inline-flex items-center gap-1 rounded border font-mono whitespace-nowrap",
      compact ? "text-[9px] px-1 py-0" : "text-[10px] px-1.5 py-0.5",
      ACTION_STYLES[action] ?? ACTION_STYLES.WATCH
    )}>
