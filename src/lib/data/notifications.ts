...
const MOCK_NOTIFICATIONS: Notification[] = [
  {
    ...
    metadata: { priority: "EXTREME", template: "release_24h", release_slug: "mercurial-superfly-elite" },
  ...
  },
  {
    ...
    metadata: { priority: "EXTREME", template: "presale_active", release_slug: "taylor-antwerp-presale" },
  ...
  },
  {
    ...
    metadata: { priority: "HIGH", template: "new_release", release_slug: "adidas-f50-elite" },
  ...
  },
  {
    ...
    metadata: { priority: "EXTREME", template: "date_changed", release_slug: "coldplay-paris-jul-2026" },
